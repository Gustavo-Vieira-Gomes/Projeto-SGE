...
from outflows.views import OutflowListView, OutflowCreateView, OutflowDetailView, OutflowCreateListAPIView, OutflowRetrieveAPIView
...
urlpatterns = [
    ...
    path('api/v1/outflows/<int:pk>/', OutflowRetrieveAPIView.as_view(), name='outflow-retrieve-api-view')
]