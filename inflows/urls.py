...
from inflows.views import InflowListView, InflowCreateView, InflowDetailView, InflowCreateListAPIView, InflowRetrieveAPIView
...
urlpatterns = [
    ...
    path('api/v1/inflows/<int:pk>/', InflowRetrieveAPIView.as_view(), name='inflow-retrieve-api-view')
]